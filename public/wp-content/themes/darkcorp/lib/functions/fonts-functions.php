...
if( !function_exists('wp_get_google_webfonts') ):
function wp_get_google_webfonts($key='', $sort='') {
$http = (!empty($_SERVER['HTTPS'])) ? "https" : "http";
if(!$key):
$key = 'AIzaSyBmPRa5TGlBRbUUV-pVPU3GxXRkD4lBtUU';
else:
...
$fontlist = wp_get_google_webfonts('AIzaSyBmPRa5TGlBRbUUV-pVPU3GxXRkD4lBtUU', 'alpha');
