...
/***************************************************************************/	
	...
	function themify_comments_in_pages($data=array()){
		...
		return '<p><input type="checkbox" name="setting-comments_pages" '.checked( themify_get( 'setting-comments_pages' ), 'on', false ).' /> Exclude comments in Pages</p>';	
	}
	...
	function themify_post_image($data=array()){
		...
		if ( themify_check( 'setting-post_image_single_disabled' ) ) {
