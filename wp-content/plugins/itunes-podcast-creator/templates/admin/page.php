...
<input id="iTunesPodcastImage" type="text" size="36" style="direction:rtl; width:100%;" name="iTunesPodcastImage" value="<?php echo get_option('iTunesPodcastImage'); ?>" class="wpss_text wpss-file" />
						...
						<tr valign="top">
							...
							<td>
								<input type="checkbox" class="main" name="Arts" value="Arts" <?php if ( get_option('iTunesCategories' ) == 'Arts' ) : echo ' checked="checked"' ; endif ?> > Arts
...
<input type="checkbox" name="TVFilm" value="TVFilm" <?php if ( get_option('iTunesCategories' ) == 'TVFilm' ) : echo ' checked="checked"' ; endif ?> > TV &amp; Film</td>
						</tr>
				       </table>
            </div></li>
            <li class="node"><span>Podcast <i class="icon-arrowleft"></i></span>
