...
class MPP_Gallery_Widget extends WP_Widget{
	
	
	public function __construct( ) {
		parent::__construct( false, __( '(MediaPress) Sitewide Galleries', 'mediapress' ) );
	}
	...
	public function widget( $args, $instance ) {
		...
		mpp_widget_save_gallery_data( 'query', $query );
		 ...
		 mpp_get_template_part( 'widgets/loop', 'gallery' );//shortcodes/gallery-entry.php
	...
	public function update( $new_instance, $old_instance ) {
		...
		if( mpp_is_registered_gallery_component( $new_instance['component'] ) )
			$instance['component'] =  $new_instance['component'] ;
		
		if( mpp_is_registered_gallery_type( $new_instance['type'] ) )
			$instance['type'] =  $new_instance['type'] ;
		
		if( mpp_is_valid_gallery_status( $new_instance['status'] ))
	...
	public function form( $instance ) {
		...
		<table>
			...
			<tr>
				...
				<td>
				<?php mpp_valid_gallery_status_dd(
					array(
...
function mpp_register_widgets() {
	...
	register_widget( 'MPP_Gallery_Widget' );
	
}
add_action( 'bp_widgets_init', 'mpp_register_widgets' );