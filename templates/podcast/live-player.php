...
<body onLoad="playPause()" class="bp-sm loading">
<div class="overlay">
    <?php $logoImg = get_option('bvrPodcastImage'); ?>
    ...
    <div id="header"><div class="container">
       ...
       <a href="#"><?php if (isset($logoImg)) { ?>
        ...
        <li><a href="#" onclick="playPause();myFunction('<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>')"><i class="icon-share-alternitive"></i> </a></li>
    </ul>
   </div></div>
...
<div id="content">
    ...
    <div class="home">
        ...
        <ul class="actions">
            <li> <?php echo get_option('bvrAuthorName'); ?>
            <div class="message"><?php echo get_option('bvrPodcastTitle'); ?><?php echo get_option('bvrPodcastSummary'); ?><br>
  ...
  elseif (is_404()) { echo "Sorry not found"; }
            ...
            <li>Tracklisting
            <div class="message"><?php echo get_option('bvrPodcastImage'); ?></div></li>
            <li>Attend a Show
            ...
            <div class="swiper-container coverflow">
                ...
                <div class="swiper-container fade">
                    <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide swiper-slide-live" data-author="DSB Radio" data-title="RadioSuzy1" data-mp3="http://drsusanblock.com:8000/stream" data-image="http://dev.bonoboville.com/wp-content/uploads/2015/05/Screen-Shot-2015-05-18-at-6.13.14-AM3.png" data-thumb="http://dev.bonoboville.com/wp-content/uploads/2015/05/Screen-Shot-2015-05-18-at-6.13.14-AM3.png">
                                <div class="scroll" dir="ltr">
                                <a class="button" href="#" onClick="pickSong(<?php echo $i; ?>);ga('send', 'event', 'mobile', 'Play Song', 'Listen Live');" >Play song <i class="icon-controller-play"></i></a>
                                <a class="button buy" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=5HGD65HVP4EEC" target="_new">Buy Tickets <i class="icon-ticket"></i></a>
                                <p>
                                    listen to the best show on earth
                                </p>
                                </div>
                            </div>
                        ...
                        if ( have_posts() ) :
                            ...
                            if ($hasTrack != "") { ?>
                                <?php $albumFull = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'large' );
                                    ...
                                    <div class="swiper-slide swiper-slide-<?php echo $i; ?>" data-author="<?php echo $artistName; ?>" data-title="<?php echo $songTitle; ?>" data-mp3="<?php echo $hasTrack; ?>" data-image="<?php echo $albumFull[0]; ?>" data-thumb="<?php echo $albumThumb[0]; ?>">
                                        ...
                                        <?php echo get_option('bvrPodcastTitle'); ?>
                                        <?php ob_start();
                                             the_content();
...
function artistLink(which) {
    var myWindow = window.open(which, "Purchase", "width=300, height=600, scrollbars=yes").focus();
}
