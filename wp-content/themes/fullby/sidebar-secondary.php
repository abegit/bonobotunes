	...
	<div class="tab-spacer">
		...
		<ul class="nav nav-tabs nav-justified">
			...
			<li class="active"><a href="#featured" data-toggle="tab"> <i class="fa fa-bolt"></i> Featured</a></li>
			<li><a href="#popular" data-toggle="tab"> <i class="fa fa-clock-o"></i> Popular</a></li>
			<li><a href="#latest" data-toggle="tab"> <i class="fa fa-clock-o"></i> Latest</a></li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane fade in active" id="featured">
				...
				<?php // POPULAR POST
				$featpost = new WP_Query( array( 'posts_per_page' => 4, 'meta_key' => 'wpb_post_views_count', 'orderby' => 'meta_value_num', 'order' => 'DESC'  ) );
