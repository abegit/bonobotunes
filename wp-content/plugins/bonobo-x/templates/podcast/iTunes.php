...
<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" version="2.0">
    <channel>
		...
		<itunes:author><?php echo get_option('iTunesAuthorName'); ?></itunes:author>
		...
		<itunes:owner>
			<itunes:name><?php echo get_option('iTunesAuthorName'); ?></itunes:name>
			<itunes:email><?php echo get_option('iTunesAuthorEmail'); ?></itunes:email>
		</itunes:owner>
        ...
        <?php while( have_posts()) : the_post(); ?>
            ...
            <item>
                ...
                <itunes:summary><![CDATA[<?php echo the_content_feed(); ?>]]></itunes:summary>
                <itunes:image href="<?php echo get_stylesheet_directory_uri(); ?>/images/show.jpg" />
                <pubDate><?php echo mysql2date( 'D, d M Y H:i:s +0000', get_post_time( 'Y-m-d H:i:s', true ), false ); ?></pubDate>
            	<!-- <description><?php echo mp3_enclosure(); ?></description> -->
