<?php if (!is_user_logged_in()) { ?>
	...
	<script>
	function yrFunction() {
    var myWindow = window.open("http://bloggamy.bonobodesigns.com/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Twitter", "Twitter Auth for Bonoboville", "width=640, height=640");
}
function myFunction() {
    var myWindow = window.open("http://bloggamy.bonobodesigns.com/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Facebook", "Facebook Login for Bonoboville", "width=640, height=640");
}
</script>
<div class="clear"></div>
</div>
