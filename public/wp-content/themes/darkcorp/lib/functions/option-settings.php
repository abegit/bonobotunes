...
array(
"name" => __("Enable Post View Count", TEMPLATE_DOMAIN),
"description" => __("Choose if you want to enable or disable post view counter.", TEMPLATE_DOMAIN),
    "section" => "post",
"id" => "post_view",
	"type" => "radio-enable-disable",
	"default" => "Disable"),
...
array( "name" => __("Advertisment in Left Sidebar", TEMPLATE_DOMAIN),
  "description" => __("Insert script code or banner code for the right sidebar. 160x600 or 120x600 dimension preferable. *use widget - Ads Left", TEMPLATE_DOMAIN),
	 "section" => "ads",
     "id" => "ads_left_sidebar",
	"type" => "textarea",
	"default" => ""),
...
"id" => "twitter_widget_id",
	...
	"default" => ""),
array(
"name" => __("RSS Feedburner url", TEMPLATE_DOMAIN),
	"description" => __("Insert your RSS Feedburner url here<br /><em>* must include full url with http://</em>", TEMPLATE_DOMAIN),
     "section" => "social",
"id" => "rss_feed",
	"type" => "text",
	"default" => ""),
